...
#fe only
python3 main.py --dataset btad -cl 02 -run 6 --is_train no --model_path $mp -pl 1 2 3 -inp 256 --sub_epochs 2 --meta_epochs 10 --infer_type fe_only -bs 32 --skip_connection yes --lr 1e-4 --lr_warm no --lr_warm_epochs 0 --freeze_enc_epochs 70 --repeat_num 2 --loss_type smooth_cls --use_in_domain_data yes --viz yes --pro yes 
